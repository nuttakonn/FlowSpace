...
START TRANSACTION;
DROP INDEX ix_workspaces_is_deleted;

DROP INDEX ix_workspaces_owner_id;

DROP INDEX ix_nodes_board_id;

DROP INDEX ix_nodes_is_deleted;

DROP INDEX ix_edges_board_id;

DROP INDEX ix_edges_is_deleted;

DROP INDEX ix_boards_is_deleted;

DROP INDEX ix_boards_workspace_id;

CREATE INDEX ix_workspaces_owner_id ON workspaces (owner_id) WHERE is_deleted = false;
...
CREATE INDEX ix_boards_workspace_id ON boards (workspace_id) WHERE is_deleted = false;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260612080305_FilteredCompoundIndexes', '10.0.9');
